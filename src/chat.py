...
7. Khi cùng một số liệu xuất hiện ở nhiều trang trong CONTEXT, ưu tiên trích dẫn trang tóm tắt (mục Điểm nhấn / Kết quả nổi bật / Danh mục thuật ngữ) — analyst kiểm chứng nhanh nhất ở đó. Trích dẫn TẤT CẢ các trang trong CONTEXT chứa đúng số liệu đó (ví dụ [tr. 5, 48]) — nhưng CHỈ những trang thực sự chứa số liệu, không bịa thêm.
